...
<head>
	...
	<title>小米手机4c立即购买</title>
	<link rel="stylesheet" href="/Mi/Public/home/css/buy.css" />
	...
	<script type="text/javascript" src="/Mi/Public/home/js/unslider.js"></script>
	<script type="text/javascript" src="/Mi/Public/home/js/buy.js"></script>
</head>
<body>
	<div id="fixed-banner">
		<div class="banner">
	...
	<div id="header">
		<div class="header-content">
			<div class="logo">
				<a href="<?php echo U('Index/index');?>"><img src="/Mi/Public/home/image/logo.png" alt="" /></a>
			</div>
	...
	<div class="phone-list">
		<ul>
			<li><a href="">小米 Note</a></li>
			<li><a href="" style="border-bottom:1px solid #333333;">小米手机4c</a></li>
			<li><a href="">小米手机4</a></li>
			<li><a href="">红米Note 2</a></li>
			<li><a href="">红米Note</a></li>
			<li><a href="">红米手机2</a></li>
			<li><a href="">红米手机2A</a></li>
			<li><a href="">对比手机</a></li>
		</ul>
	</div>
	<div id="phone-meal">
		<div class="phone-image">
			<img src="/Mi/Public/home/image/mi4c.png" alt="" />
		</div>
		<div class="phone-type">
		<div class="type-title">
			<p style="color:#333;">购买小米手机4c&nbsp;</p>
			<p style="color:#FF6700;;">1100元</p>
			<a href="<?php echo U('Show/index');?>">深入了解产品></a>
		</div>
		<div class="buy-step">
			选择版本：
		</div>
		<div class="different-type">
			<ul>
				<li value="">标准版 2GB内存+16GB容量</li>
				<li value="">高配版 3GB内存+32GB容量</li>
			</ul>	
		</div>
		<div class="buy-step">
			选择网络制式：
		...
		<div class="phone-checked">
			...
			<input type="button" value="下一步" class="next-step"/>
			<input type="submit" value="立即购买" class="buyit"/>
			<input type="button" value="缺货登记" class="no-good"/>
		</div>
	</div>
